...
\end{itemize}
\item Class \lstinline{InstationaryGridOperator} combines two grid
  operators representing the spatial discretizations of the time
  derivatives of order one and zero. This allows for very general
