...
\draw (5,4) node {\lstinline{GridOperatorSpace}};
...
\begin{itemize}
\item \lstinline{u} $\quad\leftrightarrow\quad$ $\mathbf{U}$.
\end{itemize}
...
\begin{itemize}
\item \lstinline{A} $\quad\leftrightarrow\quad$ $\mathbf{A}\in L(\mathbf{U},\mathbf{V})$.
\end{itemize}
\end{itemize}
\end{frame}
...
\lstinputlisting[basicstyle=\tiny,numbers=left, 
numberstyle=\tiny, numbersep=2pt]{../../examples/example04.hh}
\end{frame}
\mode<article>{
\begin{Lst}[File examples/example04.hh] \mbox
\nopagebreak
\lstinputlisting[basicstyle=\scriptsize,numbers=left, 
numberstyle=\tiny, numbersep=2pt]{../../examples/example04.hh}
\end{Lst}}
...
\lstinputlisting[basicstyle=\tiny,numbers=left, 
numberstyle=\tiny, numbersep=2pt]{../../examples/example04_operator.hh}
\end{frame}
\mode<article>{
\begin{Lst}[File examples/example04\_operator.hh] \mbox
\nopagebreak
\lstinputlisting[basicstyle=\scriptsize,numbers=left, 
numberstyle=\tiny, numbersep=2pt]{../../examples/example04_operator.hh}
\end{Lst}}
