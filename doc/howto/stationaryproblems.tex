...
\lstinputlisting[basicstyle=\ttfamily\tiny,numbers=left, 
numberstyle=\tiny, numbersep=5pt]{../../examples/example02_Q1.hh}
\end{frame}
\mode<article>{
...
\lstinputlisting[basicstyle=\ttfamily\tiny,numbers=left, 
numberstyle=\tiny, numbersep=5pt]{../../examples/example02_bctype.hh}
\end{frame}
\mode<article>{
...
\lstinputlisting[basicstyle=\ttfamily\tiny,numbers=left, 
numberstyle=\tiny, numbersep=5pt]{../../examples/example02_bcextension.hh}
\end{frame}
\mode<article>{
...
\lstinputlisting[basicstyle=\ttfamily\tiny,numbers=left, 
numberstyle=\tiny, numbersep=5pt]{../../examples/example02_operator.hh}
\end{frame}
\mode<article>{
