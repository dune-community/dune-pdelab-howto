...
Explain idea behind local finite elements. Mention \texttt{dune-localfunctions}

Explain $Q_1$ finite elements, including reference element.
...
struct C1LocalBasisTraits 
  : public C0LocalBasisTraits<DF,n,D,RF,m,R> 
{
...
\frametitle<presentation>{Local Basis}
\framesubtitle<presentation>{\texttt{q1localbasis.hh}}
...
\begin{frame}<presentation>[fragile,allowframebreaks,allowdisplaybreaks]
\frametitle<presentation>{Local Coefficients}
\framesubtitle<presentation>{\texttt{q1localcoefficients.hh}}
\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left, 
...
\begin{frame}<presentation>[fragile,allowframebreaks,allowdisplaybreaks]
\frametitle<presentation>{Local Interpolation}
\framesubtitle<presentation>{\texttt{q1localinterpolation.hh}}
\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left, 
...
\begin{frame}<presentation>[fragile,allowframebreaks,allowdisplaybreaks]
\frametitle<presentation>{Local Finite Element}
\framesubtitle<presentation>{\texttt{q1localfiniteelement.hh}}
\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left, 
...
\framesubtitle<presentation>{\texttt{q1localfiniteelementmap.hh}}
\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left, 
...
\begin{frame}<presentation>[fragile,allowframebreaks,allowdisplaybreaks]
\frametitle<presentation>{Grid Function Space Example}
\framesubtitle<presentation>{\texttt{q1gridfunctionspace.hh}}
\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left, 
...
\begin{center}
\includegraphics[width=0.49\textwidth]{./EPS/q1.eps}\hfill
\includegraphics[width=0.49\textwidth]{./EPS/q1interpolate.eps}
\end{center}
\end{frame}

\begin{frame}<presentation>[fragile,allowframebreaks,allowdisplaybreaks]
\frametitle<presentation>{Grid Function from Analytic Function}
\framesubtitle<presentation>{\texttt{q1analyticfunction.hh}}
\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left, 
numberstyle=\tiny, numbersep=5pt]{../../examples/q1analyticfunction.hh}
\end{frame}
\mode<article>{
\begin{Lst}[File examples/q1analyticfunction.hh] \mbox
\nopagebreak
\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left, 
numberstyle=\tiny, numbersep=5pt]{../../examples/q1analyticfunction.hh}
\end{Lst}}
...
\begin{frame}<presentation>[fragile,allowframebreaks,allowdisplaybreaks]
\frametitle<presentation>{Interpolating a Finite Element Function}
\framesubtitle<presentation>{\texttt{q1interpolate.hh}}
\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left, 
...
\begin{frame}<presentation>[fragile,allowframebreaks,allowdisplaybreaks]
\frametitle<presentation>{Integrate Interpolation Error}
\framesubtitle<presentation>{\texttt{l2interpolationerror.hh}}
\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left, 
...
\begin{frame}<presentation>[fragile,allowframebreaks,allowdisplaybreaks]
\frametitle<presentation>{Integration Example Driver}
\framesubtitle<presentation>{\texttt{q1interpolationerror.hh}}
\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left, 
...
Integrate function with example.

Interpolation error example. Use $Q_2$ as well.

\begin{frame}<presentation>[fragile,allowframebreaks,allowdisplaybreaks]
\frametitle<presentation>{$Q_2$ Integration Example Driver}
\framesubtitle<presentation>{\texttt{q2interpolationerror.hh}}
\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left, 
...
\begin{frame}<presentation>[fragile,allowframebreaks,allowdisplaybreaks]
\frametitle<presentation>{Constraints Assembler}
\framesubtitle<presentation>{\texttt{q1constraints.hh}}
\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left, 
...
\begin{frame}<presentation>[fragile,allowframebreaks,allowdisplaybreaks]
\frametitle<presentation>{Boundary Condition Type Functions}
\framesubtitle<presentation>{\texttt{q1boundaryconditiontypefunction.hh}}
\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left, 
numberstyle=\tiny, numbersep=5pt]{../../examples/q1boundaryconditiontypefunction.hh}
\end{frame}
\mode<article>{
\begin{Lst}[File examples/q1boundaryconditiontypefunction.hh] \mbox
\nopagebreak
\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left, 
numberstyle=\tiny, numbersep=5pt]{../../examples/q1boundaryconditiontypefunction.hh}
\end{Lst}}
...
\begin{frame}<presentation>[fragile,allowframebreaks,allowdisplaybreaks]
\frametitle<presentation>{Function Space with Constraints}
\framesubtitle<presentation>{\texttt{q1constrainedinterpolate.hh}}
\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left, 
...
\begin{frame}
\frametitle<presentation>{Affine Shift Function}
\begin{center}
...
Composite spaces. Taylor Hood example.

\begin{frame}<presentation>[fragile,allowframebreaks,allowdisplaybreaks]
\frametitle<presentation>{Analytic Velocity Field}
\framesubtitle<presentation>{\texttt{thvelocity.hh}}
\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left, 
...
\framesubtitle<presentation>{\texttt{thinterpolate.hh}}
\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left, 
...
Liste der Beispiele im examples Verzeichnis machen !
...
\begin{frame}<presentation>[fragile,allowframebreaks,allowdisplaybreaks]
\frametitle<presentation>{Local Operator for the Dirichlet Problem}
\framesubtitle<presentation>{\texttt{laplacedirichletop.hh}}
\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left, 
...
\begin{frame}<presentation>[fragile,allowframebreaks,allowdisplaybreaks]
\frametitle<presentation>{$Q_1$ Dirichlet Driver}
\framesubtitle<presentation>{\texttt{laplacedirichlet.hh}}
\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left, 
