...
\lstinputlisting[basicstyle=\scriptsize,tabsize=4]{../../examples/q1localbasis.hh}
\end{frame}

\begin{frame}[fragile,allowframebreaks,allowdisplaybreaks]
\frametitle<presentation>{Local Coefficients}
\lstinputlisting[basicstyle=\scriptsize,tabsize=4]{../../examples/q1localcoefficients.hh}
\end{frame}

\begin{frame}[fragile,allowframebreaks,allowdisplaybreaks]
\frametitle<presentation>{Local Interpolation}
\lstinputlisting[basicstyle=\scriptsize,tabsize=4]{../../examples/q1localinterpolation.hh}
\end{frame}

\begin{frame}[fragile,allowframebreaks,allowdisplaybreaks]
\frametitle<presentation>{Local Finite Element}
\lstinputlisting[basicstyle=\scriptsize,tabsize=4]{../../examples/q1localfiniteelement.hh}
\end{frame}

\begin{frame}[fragile,allowframebreaks,allowdisplaybreaks]
\frametitle<presentation>{Local Finite Element Map}
\lstinputlisting[basicstyle=\scriptsize,tabsize=4]{../../examples/q1localfiniteelementmap.hh}
\end{frame}

\begin{frame}[fragile,allowframebreaks,allowdisplaybreaks]
\frametitle<presentation>{Grid Function Space Example}
\lstinputlisting[basicstyle=\scriptsize,tabsize=4]{../../examples/q1gridfunctionspace.hh}
\end{frame}
