...
&+ \sum_{f\in E^1_h}
\mathbf{R}_{l(e),r(e)}^T\bm{\alpha}^\text{skel}_{h,f}(\mathbf{R}_{l(e),r(e)}\mathbf{u}) 
&&+ \sum_{f\in E^1_h} \mathbf{R}_{l(e),r(e)}^T\bm{\lambda}^\text{skel}_{h,f}\\
&+ \sum_{b\in B^1_h} \mathbf{R}_{l(e)}^T\bm{\alpha}^\text{bnd}_{h,b}(\mathbf{R}_{l(e)}\mathbf{u})
