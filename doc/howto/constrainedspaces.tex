...
\lstinputlisting[basicstyle=\scriptsize,numbers=left, 
numberstyle=\tiny, numbersep=5pt]{../../src/course-gridfunctionspace/boundaryconditiontypefunction.hh}
\end{frame}
\mode<article>{
\begin{Lst}[File src/course-gridfunctionspace/boundaryconditiontypefunction.hh] \mbox
\nopagebreak
\lstinputlisting[basicstyle=\scriptsize,numbers=left, 
numberstyle=\tiny, numbersep=5pt]{../../src/course-gridfunctionspace/boundaryconditiontypefunction.hh}
\end{Lst}}
