...
\begin{center}
\includegraphics[width=0.3\textwidth]{./EPS/example05_0_0.5} $\hspace{1mm}$
\includegraphics[width=0.3\textwidth]{./EPS/example05_0_5.0} $\hspace{1mm}$
\includegraphics[width=0.3\textwidth]{./EPS/example05_0_50.0}

\includegraphics[width=0.3\textwidth]{./EPS/example05_1_0.5} $\hspace{1mm}$
\includegraphics[width=0.3\textwidth]{./EPS/example05_1_5.0} $\hspace{1mm}$
\includegraphics[width=0.3\textwidth]{./EPS/example05_1_50.0}
\end{center}
\end{frame}
